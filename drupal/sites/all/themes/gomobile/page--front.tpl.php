...
<div id="main_container">
  ...
  <div class="content">
    ...
    <div class="left13 border_img">
      <?php print render($page['home_content_first']); ?>
    </div>
    <div class="left13 border_img">
      <?php print render($page['home_content_second']); ?>
    </div>
    <div class="left13">
      <?php print render($page['home_content_three']); ?>    
    </div>
    <?php print render($page['home_portfolio']); ?>
    <div class="divider"></div>         
    <div class="left12">
      <?php print render($page['home_twitter']); ?>
    </div>
    <div class="left12">
      <?php print render($page['home_testimonials']); ?>
    </div>
  </div>
  <div class="clear"></div>
  <div class="footer">
